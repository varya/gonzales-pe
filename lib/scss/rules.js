...
/////////////////////////////////////
    ...
    */
    ...
    /**
     * Check if token is a semicolon or newline
     * @param {Number} i Token's index number
     * @returns {Number} `1` if token is a semicolon or newline, otherwise `0`
     */
    function checkDeclDelim(i) {
        return i < tokensLength && (tokens[i].type === TokenType.Semicolon || tokens[i].type === TokenType.Newline) ? 1 : 0;
    }
    ...
    function getFunction() {
        ...
        body = ident[needInfo ? 2 : 1] === 'not' ? getNotArguments() : getArguments();
